...
function JoinSplit(params) {
  if (!(this instanceof JoinSplit)) {
    return new JoinSplit(params);
  }
  this.nullifiers = [];
  this.commitments = [];
  this.ciphertexts = [];
...
Object.defineProperty(JoinSplit.prototype, 'vpub_old', {
  configurable: false,
  enumerable: true,
  get: function() {
...
Object.defineProperty(JoinSplit.prototype, 'vpub_new', {
  configurable: false,
  enumerable: true,
  get: function() {
...
JoinSplit.fromObject = function(obj) {
  $.checkArgument(_.isObject(obj));
  var jsdesc = new JoinSplit();
  return jsdesc._fromObject(obj);
};

JoinSplit.prototype._fromObject = function(params) {
  var nullifiers = [];
...
JoinSplit.prototype.toObject = JoinSplit.prototype.toJSON = function toObject() {
  var nullifiers = [];
...
JoinSplit.fromBufferReader = function(br) {
  var i;
  var jsdesc = new JoinSplit();
...
JoinSplit.prototype.toBufferWriter = function(writer) {
  var i;
  if (!writer) {
